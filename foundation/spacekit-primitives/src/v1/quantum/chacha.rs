...
pub fn encrypt_file(input_path: &str, output_path: &str, cipher: ChaCha20Poly1305, nonce: Nonce) {
...
pub fn generate_cipher(
...
) -> Result<(ChaCha20Poly1305, Nonce), std::io::Error> {
    // Here we use ChaCha20Poly1305 for this purpose of symmetric encryption/decryption
    ...
    // Generate a nonce
    let mut nonce_bytes = [0u8; 12]; // Create an array to hold the nonce, 96-bits; unique per message
