...
echo "=== SpaceKit Storage Node Docker Build ==="
...
# standalone pulls api-server, database, p2p, quantum, … ; aws-secrets adds Secrets Manager KEM key loading
RUN cargo build --release --features "standalone,aws-secrets"
...
echo ""
echo "Binary ready for deployment: $OUTPUT_DIR/spacekit-storage-node"
echo "Need to create this facet; Deploy with: ./deploy-binary.sh"
